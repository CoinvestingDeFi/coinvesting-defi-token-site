...
function App() {
  ...
  console.log(parseInt(levelOneDate, 10));
  console.log(parseInt(levelOneDate, 10)+parseInt(levelTwoDate, 10));
  console.log(parseInt(levelOneDate, 10)+parseInt(levelTwoDate, 10)+parseInt(levelThreeDate, 10));
  console.log(parseInt(levelOneDate, 10)+parseInt(levelTwoDate, 10)+parseInt(levelThreeDate, 10)+parseInt(levelFourDate, 10));
