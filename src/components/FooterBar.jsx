...
function FooterBar() {
  ...
  return (
    <footer className="text-center" style={{color: "#ffcc00", backgroundColor: "black", margin: "auto", width: "100%", position: 'fixed', bottom: 0, left: 0}}>
      <small style={{position: 'fixed', bottom: 0, left: 0, fontSize: "10px"}}><strong>COINVEX address: <a target="blank" href="https://etherscan.io/token/0x8befccc83c01ab01bf9de70093254a95a6e79122">0x8befccc83c01ab01bf9de70093254a95a6e79122</a></strong></small>
